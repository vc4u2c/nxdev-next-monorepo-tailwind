...
function CreateResourceGroup {
  ...
  $resourceGroupId = $(az group create --name "rg-$ProjectName-$environmentAbbr" --location $AzureLocation --query id --output tsv)
...
function SetVariables() {
  ...
  gh variable set PROJECT_NAME_$ProjectNameUpper --body $ProjectName --repo $repoUrl
}
...
function SetEnvironmentVariablesAndSecrets {
  ...
  gh variable set AZURE_CLIENT_ID_$ProjectNameUpper --body "$appId" --env $environmentName --repo $repoUrl
  gh variable set AZURE_RESOURCE_GROUP_NAME_$ProjectNameUpper --body "rg-$ProjectName-$environmentAbbr" --env $environmentName --repo $repoUrl
}
